...
import { FoodViewAddComponent } from './food-view-add/food-view-add.component';
import { FoodDetailsComponent } from '../../user/foods/food-details/food-details.component';
import { FoodViewUpdateComponent } from './food-view-update/food-view-update.component';

@Component({
  selector: 'app-foods-view',
  standalone: true,
  imports: [CommonModule, FoodViewAddComponent, FoodViewUpdateComponent, FoodDetailsComponent],
...
export class FoodViewComponent implements OnInit {
  ...
  openAddFood(): void {
    this.selectedAddFood = true;
    this.selectedFood = null;
    this.isUpdateMode = false;
    this.showFoodDetails = false;
  }

  openUpdateFood(food: Food): void {
    this.selectedFood = food;
    this.selectedAddFood = true;
